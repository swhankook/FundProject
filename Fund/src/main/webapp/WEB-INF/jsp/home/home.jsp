...
<%@ include file="/WEB-INF/jsp/template/include/lib.jsp"%>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    ...
                                    <a class="btn-slide animation animated-item-3" href="/loan/loanWrite">대출상담</a>
                                </div>
                            </div>
	...
	<div class="about">
		<div class="container">
			<div class="col-md-6 fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" >
				<h2>about us</h2>
	...
	<div class="lates">
		<div class="container">
			...
			<div class="col-md-4 fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
			...
			<div class="col-md-4 fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
				<img src="/resources/images/4.jpg" class="img-responsive"/>
				<h3>Template built with Twitter Bootstrap</h3>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus interdum erat
				libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque
	...
	<section id="partner">
        <div class="container">
            ...
            <div class="partners">
                <ul>
                    <li> <a href="#"><img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" src="/resources/images/partners/partner1.png"></a></li>
                    <li> <a href="#"><img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" src="/resources/images/partners/partner2.png"></a></li>
                    <li> <a href="#"><img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms" src="/resources/images/partners/partner3.png"></a></li>
                    <li> <a href="#"><img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="1200ms" src="/resources/images/partners/partner4.png"></a></li>
                    <li> <a href="#"><img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="1500ms" src="/resources/images/partners/partner5.png"></a></li>
                </ul>
            </div>
        </div><!--/.container-->
    </section><!--/#partner-->
	...
	<section id="conatcat-info">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <div class="media contact-info fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="pull-left">
