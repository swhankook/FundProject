...
<div class="loanWrite">
	...
	<fieldset class="write-pannel">
		...
		<div class="form-group row">
    		...
    		<div class="col-xs-6 inputGroupContainer">
   				 <div class="input-group">
				 	 <input name="birthday" id="birthday" placeholder="1988-01-01" class="form-control"  type="text" >
				  </div>
			 </div>
		</div>
		<div class="form-group row">
		...
		<div class= "submitButton">
  			<button class="btn btn-success write-btn" type="button" onclick="loanWrite.loan();">등록하기</button>
		</div>
